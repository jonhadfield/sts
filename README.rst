...
::
    ...
    curl -L "https://github.com/jonhadfield/sts/releases/download/1.0.0/sts_linux_amd64" -o /usr/local/bin/sts ; chmod +x /usr/local/bin/sts

on MacOS:
::
    curl -L "https://github.com/jonhadfield/sts/releases/download/1.0.0/sts_darwin_amd64" -o /usr/local/bin/sts ; chmod +x /usr/local/bin/sts
